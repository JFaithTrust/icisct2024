...
export default function Home() {
    return (
        <main className="flex flex-col gap-y-2 mx-auto p-6 bg-white shadow-md rounded-md">
            <h1 className={"text-lg font-semibold text-center mb-8"}>
                International Conference on Information Science and Communications Technologies - Applications, Trends
                and
                Opportunities</h1>
            <div className={"flex gap-4"}>
                <img src="/home.png" className={"object-cover rounded-xl"} alt="Image"/>
